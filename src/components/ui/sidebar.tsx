...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden text-sidebar-foreground md:block border-r border-neutral-300 dark:border-neutral-900"
        data-state={state}
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] md:peer-data-[variant=inset]:ml-0 ",
        className
      )}
      {...props}
    />
